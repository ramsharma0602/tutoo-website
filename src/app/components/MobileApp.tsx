      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-8">
        ...
        >
          ...
          >
            ...
            <span className="text-sm font-medium text-[#0A1028]">Available on iOS & Android</span>
          </motion.div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
            {features.map((feature, i) => (
              ...
              >
                ...
                <span className="text-sm font-semibold text-[#0A1028]">{feature.label}</span>
              </motion.div>
            ))}
          </div>
        </motion.div>
        ...
        >
          <button className="flex items-center gap-3 px-8 py-4 bg-[#0A1028] text-white rounded-2xl hover:bg-[#1a2332] transition-all duration-300 shadow-lg">
