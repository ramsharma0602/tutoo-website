...
const steps = [
  ...
  },
  {
    ...
    color: "#7B2FF7",
    glow: "rgba(248,120,8,0.35)",
    border: "rgba(248,120,8,0.4)",
  ...
  },
  {
    ...
    color: "#7B2FF7",
    glow: "rgba(248,120,8,0.4)",
    border: "rgba(248,120,8,0.5)",
    bg: "rgba(248,120,8,0.08)",
  },
  {
    num: "06",
    ...
    color: "#7B2FF7",
    glow: "rgba(248,120,8,0.5)",
    border: "rgba(248,120,8,0.6)",
    bg: "rgba(248,120,8,0.12)",
  },
];
...
const floatingChips = [
  { label: "Verified Tutor ✓", c: "text-[#7B2FF7] bg-[rgba(248,120,8,0.1)] border-[rgba(248,120,8,0.25)]" },
  { label: "Background Checked", c: "text-[#7B2FF7] bg-[rgba(123,47,247,0.1)] border-[rgba(123,47,247,0.22)]" },
  { label: "● Live Monitoring", c: "text-[#F59E0B] bg-[rgba(245,158,11,0.1)] border-[rgba(245,158,11,0.22)]" },
  { label: "Safety Approved", c: "text-[#7B2FF7] bg-[rgba(123,47,247,0.1)] border-[rgba(123,47,247,0.22)]" },
  { label: "AI Alerts Active", c: "text-[#7B2FF7] bg-[rgba(248,120,8,0.1)] border-[rgba(248,120,8,0.25)]" },
];

const dashStats = [
  { label: "Verification Score", value: "98.4%", color: "#7B2FF7" },
  { label: "Active Sessions", value: "1,240", color: "#7B2FF7" },
  { label: "OTP Verified", value: "100%", color: "#7B2FF7" },
...
export function SafetyVerificationSection() {
  ...
  return (
    <section className="relative overflow-hidden py-28" style={{ background: "#0A1028" }}>

      {/* ── Background atmosphere ── */}
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        {/* Mesh glows */}
        <div className="absolute -top-32 -left-32 w-[600px] h-[600px] rounded-full opacity-30"
          style={{ background: "radial-gradient(circle, rgba(248,120,8,0.18), transparent 70%)", filter: "blur(60px)" }} />
        ...
        <div className="absolute bottom-0 left-1/3 w-[400px] h-[400px] rounded-full opacity-20"
          style={{ background: "radial-gradient(circle, rgba(123,47,247,0.18), transparent 70%)", filter: "blur(60px)" }} />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8">
        ...
        >
          ...
          <div className="inline-flex items-center gap-2 px-5 py-2 rounded-full border mb-8"
            style={{ background: "rgba(248,120,8,0.08)", borderColor: "rgba(248,120,8,0.3)", backdropFilter: "blur(12px)" }}>
            <ShieldCheck className="w-4 h-4 text-[#7B2FF7]" />
            <span className="text-sm font-semibold text-[#7B2FF7]">Safety & Verification</span>
          </div>
          ...
          <div ref={timelineRef}>
            <div className="relative">
              ...
              <div className="absolute left-[27px] top-8 bottom-8 w-[2px]"
                style={{ background: "linear-gradient(to bottom, rgba(248,120,8,0.15), rgba(123,47,247,0.15), rgba(123,47,247,0.15))" }}>
                <motion.div
                    ...
                    >
                      ...
                      {i === steps.length - 1 && (
                        <div className="flex items-center gap-2 mt-3 pt-3 border-t border-[rgba(255,255,255,0.07)]">
                          ...
                          <span className="text-xs font-semibold text-[#7B2FF7]">Tutor Activated for Live Sessions</span>
                        </div>
                      )}
                    </div>
                  </motion.div>
          ...
          >
            ...
            <div className="rounded-3xl border p-6"
              ...
              <div className="flex items-center gap-3 mb-5">
                <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-[#EA580C] to-[#C2410C] flex items-center justify-center shadow-lg">
                  <Lock className="w-4 h-4 text-white" />
                </div>
                <div>
                  <p className="text-sm font-bold text-white">Security Dashboard</p>
                  <p className="text-xs text-[#6E6A85]">Real-time verification status</p>
                </div>
                <div className="ml-auto flex items-center gap-1.5 text-xs font-semibold text-[#7B2FF7]">
              ...
              <div className="grid grid-cols-2 gap-3">
                {dashStats.map((ds) => (
                  <div key={ds.label} className="rounded-2xl p-4 text-center"
                    ...
                    <p className="text-[10px] font-semibold text-[#6E6A85] uppercase tracking-wider">{ds.label}</p>
                  </div>
                ))}
              </div>
              ...
              <div className="mt-4 pt-4 border-t border-[rgba(255,255,255,0.06)]">
                <div className="flex justify-between mb-2">
                  ...
                  <span className="text-xs font-bold text-[#7B2FF7]">98.4 / 100</span>
                </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              {cards.map((card, i) => (
                ...
                >
                  ...
                  <p className="text-xs leading-relaxed text-[#6E6A85] mb-3">{card.desc}</p>
            ...
            <div className="rounded-2xl border p-5 flex gap-4 items-start"
              style={{ background: "linear-gradient(135deg, rgba(123,47,247,0.08), rgba(123,47,247,0.08))", borderColor: "rgba(123,47,247,0.2)" }}>
              <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-[#7B2FF7] to-[#7B2FF7] flex items-center justify-center shadow-lg shrink-0">
                <Eye className="w-5 h-5 text-white" />
              </div>
              <div>
                <p className="text-[10px] font-black uppercase tracking-widest text-[#7B2FF7] mb-1">AI Safety System</p>
            ...
            <div className="flex flex-wrap items-center gap-5 mt-2">
              <button className="group h-14 px-8 rounded-2xl bg-gradient-to-r from-[#EA580C] to-[#C2410C] text-white font-semibold shadow-xl shadow-[#EA580C]/25 hover:scale-[1.02] transition-all duration-300 flex items-center gap-2">
