  ...
  return (
    <section className="relative overflow-hidden py-28 bg-white">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-0 left-0 w-[450px] h-[450px] bg-[#7B2FF7]/10 rounded-full blur-3xl" />

        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[700px] h-[700px] bg-[#7B2FF7]/5 rounded-full blur-3xl" />
      </div>
        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          ...
          >
            ...
            <div className="inline-flex items-center gap-2 px-5 py-2 rounded-full bg-white/70 backdrop-blur-xl border border-[#7B2FF7]/20 shadow-sm mb-8">
              ...
              <Laptop className="w-4 h-4 text-[#7B2FF7]" />
            ...
            <div className="grid gap-4 mt-10">
              ...
              {benefits.map((benefit, index) => (
                ...
                <motion.div
                  ...
                  viewport={{ once: true }}
                  className="group flex items-center gap-4 rounded-2xl bg-[#FAFAFC]/80 backdrop-blur-xl border border-[rgba(30,27,58,0.06)] shadow-sm px-5 py-4 hover:shadow-lg transition-all duration-300"
                >
          ...
          >
            ...
            {/* Glow Behind */}
            <div className="absolute -z-10 -top-10 -right-10 w-64 h-64 bg-[#7B2FF7]/20 rounded-full blur-3xl" />
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2 mt-1">
                    ...
                    <span className="text-xs text-[#6E6A85]">
                      Active Session
                    </span>
                  </div>
                </div>
            ...
            >
              ...
              <div className="flex items-center justify-between mb-5">
                ...
                <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-[#EA580C] to-[#C2410C] flex items-center justify-center shadow-lg">

                  <Wand2 className="w-6 h-6 text-white" />
                </div>
              </div>

              <div className="rounded-2xl bg-[#FAFAFC] border border-[rgba(30,27,58,0.06)] p-4">

                <p className="text-sm font-semibold text-[#1E1B3A]">
                  Revise Algebra Chapter
                </p>

                <p className="text-xs text-[#6E6A85] mt-2 leading-6">
