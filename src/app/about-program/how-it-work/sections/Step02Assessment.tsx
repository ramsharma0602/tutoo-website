...
───────────────────────────────────────────── */
const insightCards = [
  { emoji: "📊", icon: BarChart2,     title: "Current Academic Level", desc: "Understand exactly where the student stands today against expected curriculum milestones.", color: "#7B2FF7", bg: "rgba(123,47,247,0.08)",  border: "rgba(123,47,247,0.2)",  grad: "from-[#7B2FF7] to-[#7B2FF7]" },
  { emoji: "💪", icon: Zap,           title: "Strengths",               desc: "Identify subjects and concepts already mastered to build further confidence.",             color: "#7B2FF7", bg: "rgba(248,120,8,0.08)", border: "rgba(248,120,8,0.2)", grad: "from-[#EA580C] to-[#C2410C]" },
  ...
  { emoji: "🧠", icon: Brain,         title: "Learning Style",          desc: "Visual, practical, conceptual, or interactive — every student learns differently.",        color: "#7B2FF7", bg: "rgba(123,47,247,0.08)", border: "rgba(123,47,247,0.2)", grad: "from-[#7B2FF7] to-[#7B2FF7]" },
  { emoji: "🎯", icon: Target,        title: "Aptitude Indicators",     desc: "Discover hidden strengths, subject affinities, and future academic potential.",           color: "#7B2FF7", bg: "rgba(123,47,247,0.08)",  border: "rgba(123,47,247,0.2)",  grad: "from-[#7B2FF7] to-[#7B2FF7]" },
];

const subjectData = [
  { label: "Mathematics", val: 60, color: "#7B2FF7", grad: "linear-gradient(90deg,#7B2FF7,#7B2FF7)", ring: 138, gap: 55 },
  { label: "Science",     val: 82, color: "#7B2FF7", grad: "linear-gradient(90deg,#7B2FF7,#7B2FF7)", ring: 138, gap: 25 },
  { label: "English",     val: 91, color: "#7B2FF7", grad: "linear-gradient(90deg,#7B2FF7,#7B2FF7)", ring: 138, gap: 12 },
];
    ...
    <div className="flex flex-col items-center gap-2">
      <div className="relative w-14 h-14">
        <svg width="56" height="56" viewBox="0 0 56 56" style={{ transform: "rotate(-90deg)" }}>
          <circle cx="28" cy="28" r={r} fill="none" stroke="rgba(30,27,58,0.07)" strokeWidth="4" />
          <motion.circle
  ...
  return (
    <div ref={ref} className="flex flex-col gap-4">
        ...
        <div className="p-6">
          ...
          <div className="flex items-center justify-between mb-5">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-[#7B2FF7] to-[#7B2FF7] flex items-center justify-center shadow-md">
          ...
          <div className="flex flex-col gap-2.5 mb-5">
            {[
              ...
              { label: "Current Level (Student)",  val: 60,  grad: "linear-gradient(90deg,#7B2FF7,#7B2FF7)", color: "#7B2FF7", delay: 0.5 },
            ].map((bar) => (
              <div key={bar.label}>
      ...
      <motion.div
        ...
        style={{ background: "linear-gradient(135deg,#0A1028,#111827)", boxShadow: "0 8px 32px rgba(30,27,58,0.18)" }}
      >
        <div className="h-[2px] bg-gradient-to-r from-[#EA580C] to-[#C2410C]" />
        <div className="p-5 flex gap-4 items-start">
          <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-[#EA580C] to-[#C2410C] flex items-center justify-center shadow-lg shrink-0">
      ...
      >
        ...
        {[
          { dot: "#7B2FF7", text: "Mathematics skill gap identified at Grade 6 level",  icon: <Activity className="w-3.5 h-3.5" /> },
          { dot: "#7B2FF7", text: "Science performance strong — 82% proficiency",        icon: <TrendingUp className="w-3.5 h-3.5" /> },
          { dot: "#7B2FF7", text: "Visual learning style detected from test responses",  icon: <Brain className="w-3.5 h-3.5" /> },
        ].map((n, i) => (
          <motion.div key={i}
    ...
    <section className="relative overflow-hidden bg-[#FAFAFC] py-28">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <div className="absolute -top-32 right-0 w-[600px] h-[500px] rounded-full opacity-20"
          style={{ background: "radial-gradient(ellipse, rgba(123,47,247,0.12), transparent 70%)", filter: "blur(70px)" }} />
        ...
        {[...Array(10)].map((_, i) => (
          <motion.div key={i} className="absolute rounded-full"
            style={{ width: 2, height: 2, background: i % 3 === 0 ? "#7B2FF7" : i % 3 === 1 ? "#7B2FF7" : "#7B2FF7", left: `${(i * 18 + 5) % 96}%`, top: `${(i * 13 + 6) % 88}%`, opacity: 0.3 }}
          ...
          >
            ...
            <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} transition={{ delay: 0.6 }}>
                  ...
                  <div key={s.label} className="flex items-center">
                    ...
                    {i < progressSteps.length - 1 && (
                      <div className="w-10 h-[2px] mx-1 rounded-full"
                        style={{ background: i < 1 ? "linear-gradient(90deg, #7B2FF7, #7B2FF7)" : "rgba(30,27,58,0.08)" }} />
                    )}
                  </div>
                ))}
              </div>
              <div className="flex items-center gap-2">
                ...
                <p className="text-xs font-bold text-[#7B2FF7]">Assessment Completed · Step 2 of 5</p>
              </div>
            </motion.div>
