...
function FutureVisual() {
  return (
    <div className="relative w-full h-full min-h-[540px] flex items-center justify-center">
      {/* Base image card */}
      <div className="relative w-full rounded-[36px] overflow-hidden shadow-[0_28px_90px_rgba(30,27,58,0.14)] border border-white/50">
        <img
        ...
        />
        {/* Multi-layer overlay */}
        <div className="absolute inset-0 bg-gradient-to-t from-[#0A1028]/70 via-[#0A1028]/15 to-transparent" />
        <div className="absolute inset-0 bg-gradient-to-br from-[#7B2FF7]/15 via-transparent to-[#7B2FF7]/15" />
        ...
        <svg className="absolute inset-0 w-full h-full opacity-[0.12] pointer-events-none">
          ...
          {/* Corner brackets */}
          <path d="M20,20 L40,20 M20,20 L20,40" stroke="#7B2FF7" strokeWidth="1.5" fill="none" />
          <path d="M80,20 L60,20 M80,20 L80,40" stroke="#7B2FF7" strokeWidth="1.5" fill="none" />
          <path d="M20,80 L40,80 M20,80 L20,60" stroke="#7B2FF7" strokeWidth="1.5" fill="none" />
          <path d="M80,80 L60,80 M80,80 L80,60" stroke="#7B2FF7" strokeWidth="1.5" fill="none" />
          {/* Center crosshair */}
          <circle cx="50%" cy="50%" r="24" stroke="#7B2FF7" strokeWidth="0.8" fill="none" strokeDasharray="4 3" />
          <circle cx="50%" cy="50%" r="8" stroke="#7B2FF7" strokeWidth="1" fill="none" />
        </svg>
        ...
        <div className="absolute bottom-0 left-0 right-0 p-7">
          ...
          <div className="flex flex-wrap gap-2 mb-4">
            {[
              { icon: Brain,  label: "AI Learning",    c: "#7B2FF7" },
              { icon: Cpu,    label: "Smart Platform", c: "#7B2FF7" },
              { icon: Layers, label: "Personalised",   c: "#7B2FF7" },
            ].map((t) => {
              const Icon = t.icon;
              return (
                <span key={t.label}
          ...
          <p className="text-white text-xl font-black leading-snug"
            ...
            <span className="text-[#6D28D9]"> Personalized & Boundless</span>
          </p>
        </div>
      </div>

      {/* Glow behind card */}
      <div className="absolute -z-10 -top-10 -right-10 w-72 h-72 bg-[#7B2FF7]/18 rounded-full blur-3xl" />
      <div className="absolute -z-10 -bottom-10 -left-10 w-60 h-60 bg-[#7B2FF7]/18 rounded-full blur-3xl" />
      ...
      {FLOAT_METRICS.map((m, i) => {
        ...
        return (
          ...
          >
            ...
            <div>
              <p className="text-base font-black text-[#1E1B3A] leading-none"
                style={{ fontFamily: "var(--font-heading, 'Clash Display', sans-serif)" }}>
                {m.value}
              </p>
              <p className="text-[11px] text-[#6E6A85] mt-0.5 font-semibold">{m.label}</p>
            </div>
          </motion.div>
        );
      })}
      ...
      >
        <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-[#EA580C] to-[#C2410C]
                        flex items-center justify-center shadow-[0_0_32px_rgba(248,120,8,0.6)]">
...
export function VisionFutureSection() {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center mb-24">
          ...
          >
            ...
            {/* Heading */}
            <h2
              className="text-5xl lg:text-[60px] font-black leading-[1.05] tracking-tight text-[#0A1028] mb-8"
            ...
            <div className="space-y-5 mb-12">
              {BODY_PARAGRAPHS.map((para, i) => (
                <motion.p
                  ...
                  className="text-lg leading-9 text-[#6E6A85]"
                >
                  {para}
                </motion.p>
              ))}
                ...
                return (
                  ...
                  >
                    ...
                    <div className="relative z-10 flex-1">
                      <p className="font-black text-[#1E1B3A] mb-1"
                        style={{ fontFamily: "var(--font-heading, 'General Sans', sans-serif)" }}>
                        {p.emoji} {p.title}
                      </p>
                      <p className="text-sm leading-6 text-[#6E6A85]">{p.desc}</p>
                    </div>
                    <ArrowRight className="w-4 h-4 text-[#7B2FF7] mt-1 flex-shrink-0 relative z-10
            ...
            <div className="flex flex-wrap items-center gap-5">
              ...
              <button className="text-[#7B2FF7] font-bold hover:text-[#7B2FF7] transition-colors duration-300">
                Find a Tutor →
              </button>
            </div>
          </motion.div>
            ...
            return (
              <motion.div
                ...
                className="group rounded-3xl bg-white/80 backdrop-blur-xl
                           border border-[rgba(30,27,58,0.07)]
                           shadow-[0_4px_28px_rgba(30,27,58,0.07)]
                           hover:shadow-[0_16px_48px_rgba(30,27,58,0.10)]
              ...
              >
                ...
                <p className="text-xs font-semibold text-[#6E6A85]">{s.label}</p>
              </motion.div>
            );
          })}
        </motion.div>
        ...
        <motion.div
          ...
          style={{
            ...
            boxShadow:
              "0 28px 88px rgba(248,120,8,0.10), 0 8px 36px rgba(123,47,247,0.08)",
          }}
        >
          <div className="absolute top-0 right-0 w-72 h-72 bg-[#7B2FF7]/06 rounded-full blur-3xl pointer-events-none" />
          <div className="absolute bottom-0 left-0 w-64 h-64 bg-[#7B2FF7]/05 rounded-full blur-3xl pointer-events-none" />
          ...
          <div className="relative z-10 max-w-4xl mx-auto">
            ...
            <p
              className="text-3xl lg:text-[40px] font-black text-[#1E1B3A] leading-tight mb-4"
              style={{ fontFamily: "var(--font-heading, 'Clash Display', sans-serif)" }}
            >
            ...
            {/* Proof row */}
            <div className="flex flex-wrap justify-center gap-3 pt-9 border-t border-[rgba(30,27,58,0.07)]">
              {[
                { text: "Personalized",      c: "#7B2FF7" },
                { text: "Accessible",        c: "#7B2FF7" },
                { text: "Technology-Driven", c: "#7B2FF7" },
      ...
      <style>{`
        @keyframes aiPulse {
          0%,100% { box-shadow: 0 0 0 0 rgba(248,120,8,0.3), 0 0 32px rgba(248,120,8,0.6); }
          50%      { box-shadow: 0 0 0 18px rgba(248,120,8,0), 0 0 32px rgba(248,120,8,0.6); }
        }
      `}</style>
    </section>
  );
