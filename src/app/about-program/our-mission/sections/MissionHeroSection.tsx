...
export function OurMissionSection() {
  ...
  return (
    <div ref={sectionRef} className="bg-[#FAFAFC] overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none overflow-hidden">
          ...
          >
            <div className="w-full h-full rounded-full"
              style={{ background: "radial-gradient(ellipse, rgba(123,47,247,0.1) 0%, rgba(248,120,8,0.07) 50%, transparent 75%)", filter: "blur(60px)" }} />
          </motion.div>

          <motion.div style={{ y: yOrb2, background: "radial-gradient(circle, rgba(123,47,247,0.14), transparent 70%)", filter: "blur(70px)" }}
          ...
          <div className="absolute bottom-0 -left-24 w-[450px] h-[380px] rounded-full opacity-20"
            style={{ background: "radial-gradient(circle, rgba(248,120,8,0.14), transparent 70%)", filter: "blur(60px)" }} />
          ...
          {[...Array(6)].map((_, i) => (
            <motion.div key={`net-${i}`}
              ...
              style={{
                ...
                borderColor: i % 2 === 0 ? "rgba(123,47,247,0.05)" : "rgba(248,120,8,0.05)",
      ...
      <section className="relative py-20 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 lg:px-8">
          <motion.div
            ...
            style={{ background: "rgba(255,255,255,0.85)", borderColor: "rgba(30,27,58,0.07)", backdropFilter: "blur(20px)", boxShadow: "0 16px 60px rgba(30,27,58,0.09)" }}
          >
            {/* Top gradient stripe */}
            ...
            <div className="absolute -top-10 -left-10 w-40 h-40 rounded-full opacity-30"
              style={{ background: "radial-gradient(circle, rgba(248,120,8,0.3), transparent 70%)", filter: "blur(30px)" }} />
            <div className="absolute -bottom-10 -right-10 w-40 h-40 rounded-full opacity-20"
              style={{ background: "radial-gradient(circle, rgba(123,47,247,0.3), transparent 70%)", filter: "blur(30px)" }} />
            ...
            <div className="flex items-center justify-center gap-3 pt-6 border-t border-[rgba(30,27,58,0.06)]">
              ...
              <div className="text-left">
                <p className="text-sm font-bold text-[#1E1B3A]">Tutoo Team</p>
      ...
      <section className="relative py-16 overflow-hidden">
        <div className="relative z-10 max-w-6xl mx-auto px-6 lg:px-8">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
            ...
            <p className="text-lg text-[#6E6A85] max-w-xl mx-auto">Every student's path from struggle to success — guided by technology and human expertise.</p>
          </motion.div>
      ...
      ══════════════════════════════════════════ */}
      <section className="relative py-20 overflow-hidden" style={{ background: "#0A1028" }}>
        <div className="absolute inset-0 pointer-events-none overflow-hidden">
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[400px] rounded-full opacity-10"
            style={{ background: "radial-gradient(ellipse, rgba(123,47,247,0.18), transparent 70%)", filter: "blur(60px)" }} />
          <div className="absolute inset-0" style={{
      ...
      <section className="relative py-20 overflow-hidden bg-[#FAFAFC]">
        ...
        <div className="relative z-10 max-w-3xl mx-auto px-6 lg:px-8 text-center">
          <motion.div initial={{ opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            ...
            <p className="text-lg text-[#6E6A85] leading-8 mb-10 max-w-xl mx-auto">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <button className="group h-14 px-9 rounded-2xl bg-gradient-to-r from-[#EA580C] to-[#C2410C] text-white font-bold shadow-xl shadow-[#EA580C]/20 hover:scale-[1.02] hover:shadow-[#7B2FF7]/30 transition-all duration-300 flex items-center gap-2">
                Get Started Free
                <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform duration-300" />
              </button>
              <button className="h-14 px-9 rounded-2xl border font-semibold text-[#7B2FF7] hover:border-[#7B2FF7] transition-all duration-300"
                style={{ background: "rgba(255,255,255,0.85)", borderColor: "rgba(30,27,58,0.12)", backdropFilter: "blur(10px)" }}>
                Learn About Us
              </button>
            </div>
          </motion.div>
