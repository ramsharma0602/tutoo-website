  ...
  return (
    <motion.div
      ...
      className="group relative flex-1 rounded-3xl bg-white backdrop-blur-xl overflow-hidden
                 ...
                 shadow-[0_6px_32px_rgba(30,27,58,0.07)]
                 hover:shadow-[0_24px_56px_rgba(30,27,58,0.12)]
    ...
    >
      ...
      <div className="relative z-10">
        ...
        {/* Desc */}
        <p className="text-sm leading-7 text-[#6E6A85]">{card.desc}</p>
      </div>
  ...
  return (
    <motion.div
      ...
      className="group relative rounded-3xl overflow-hidden bg-white/80 backdrop-blur-xl
                 border border-[rgba(30,27,58,0.07)]
                 shadow-[0_4px_28px_rgba(30,27,58,0.06)]
                 hover:shadow-[0_20px_56px_rgba(30,27,58,0.10)]
...
function Particles() {
  const dots = [
    { x: 8, y: 15, c: "#7B2FF7", s: 6, d: 0 },
    { x: 92, y: 22, c: "#7B2FF7", s: 8, d: 0.5 },
    { x: 18, y: 75, c: "#7B2FF7", s: 5, d: 1 },
    { x: 85, y: 68, c: "#F59E0B", s: 7, d: 0.3 },
    { x: 50, y: 5,  c: "#7B2FF7", s: 4, d: 0.8 },
    { x: 72, y: 90, c: "#7B2FF7", s: 6, d: 1.2 },
  ];
  return (
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8">
          ...
          >
            ...
            <span className="relative inline-block">
              <span className="bg-gradient-to-r from-[#7B2FF7] via-[#7B2FF7] to-[#7B2FF7] bg-clip-text text-transparent
                               drop-shadow-[0_0_44px_rgba(248,120,8,0.25)]">
                Future of Personalized
              </span>
              <br />
              <span className="bg-gradient-to-r from-[#7B2FF7] via-[#7B2FF7] to-[#7B2FF7] bg-clip-text text-transparent
                               drop-shadow-[0_0_44px_rgba(123,47,247,0.25)]">
                Education
              </span>
            </span>
          </motion.h2>
        ...
        >
          <motion.div
            ...
            style={{
              ...
              boxShadow: "0 24px 80px rgba(248,120,8,0.10), 0 0 0 1px rgba(123,47,247,0.06)",
            }}
          >
            {/* Ambient glows */}
            <div className="absolute top-0 left-0 w-80 h-80 bg-[#7B2FF7]/08 rounded-full blur-3xl" />
            <div className="absolute bottom-0 right-0 w-72 h-72 bg-[#7B2FF7]/08 rounded-full blur-3xl" />
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-48 bg-[#7B2FF7]/04 rounded-full blur-2xl" />

            <div className="relative z-10">
              {/* Giant quote icon */}
              <div className="w-16 h-16 mx-auto rounded-2xl bg-gradient-to-br from-[#EA580C] to-[#C2410C] flex items-center justify-center shadow-xl mb-10">
        ...
        <div className="mb-8">
          ...
          <div className="hidden lg:block mb-6 px-4">
            <div className="relative h-1.5 rounded-full bg-[#F6F3FC] overflow-hidden">
              <motion.div
                initial={{ width: 0 }}
                ...
                style={{ background: "linear-gradient(90deg, #7B2FF7, #7B2FF7, #7B2FF7, #7B2FF7)" }}
              />
              {/* Year milestones */}
              {[0, 33.3, 66.6, 100].map((pct, i) => (
                <motion.div
                  ...
                  style={{
                    ...
                    background: ["#7B2FF7","#7B2FF7","#7B2FF7","#7B2FF7"][i],
                  }}
                />
              ))}
            </div>
        ...
        <motion.div
          ...
          style={{
            ...
            boxShadow: "0 32px 100px rgba(10,16,40,0.30)",
          }}
        >
          {/* Glow layers */}
          <div className="absolute inset-0 pointer-events-none">
            <div className="absolute top-0 left-0 w-96 h-72 bg-[#7B2FF7]/12 rounded-full blur-3xl" />
            <div className="absolute bottom-0 right-0 w-80 h-64 bg-[#7B2FF7]/12 rounded-full blur-3xl" />
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-40 bg-[#7B2FF7]/06 rounded-full blur-3xl" />
          </div>
          ...
          <div className="relative z-10 py-20 px-10 lg:px-20 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-5 mb-12">
              {[
                { icon: GraduationCap, label: "Student-first always", c: "#7B2FF7" },
                { icon: Eye,           label: "Full transparency",     c: "#7B2FF7" },
                { icon: TrendingUp,    label: "Proven growth",         c: "#7B2FF7" },
              ].map((item, i) => {
