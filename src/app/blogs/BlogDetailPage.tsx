...
function RenderSection({ section, index }: { section: BlogSection; index: number }) {
    return (
        ...
        >
            ...
            {section.type === "tip" && (
                <div className="my-8 rounded-2xl border-l-4 border-[#7B2FF7] p-6 flex gap-4"
                    style={{ background: "rgba(248,120,8,0.06)", border: "1px solid rgba(248,120,8,0.18)", borderLeftWidth: 4, borderLeftColor: "#7B2FF7" }}>
                    <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-[#EA580C] to-[#C2410C] flex items-center justify-center shrink-0 shadow-md mt-0.5">
            ...
            {section.type === "quote" && (
                <div className="my-10 relative pl-8">
                    ...
                    {section.attribution && (
                        <p className="text-sm text-[#6E6A85] font-semibold">— {section.attribution}</p>
                    )}
                </div>
            )}
                ...
                <div className="my-8 rounded-2xl border p-6 flex flex-col gap-3"
                    ...
                    {section.items.map((item, i) => (
                        <div key={i} className="flex items-start gap-3">
                            ...
                            <span className="text-base text-[#1E1B3A] leading-relaxed">{item}</span>
                        </div>
                    ))}
                </div>
            )}
...
export function BlogDetailPage({
    ...
    if (!post) {
        return (
            <div className="min-h-screen mt-20 flex flex-col items-center justify-center gap-4 bg-[#FAFAFC] px-6 text-center">
                <h1 className="text-3xl font-bold text-[#1E1B3A]">Article not found</h1>
                <p className="text-[#6E6A85] max-w-md">
                    The article you're looking for doesn't exist or may have been moved.
                </p>
                <button
                    onClick={() => navigate("/blogs")}
                    className="mt-2 px-6 py-3 rounded-full bg-[#7B2FF7] text-white font-semibold hover:bg-[#12A76B] transition-colors"
                >
                    Back to Blog
                </button>
            </div>
    ...
    return (
        <div className="relative bg-[#FAFAFC] min-h-screen mt-20" ref={articleRef}>
            ...
            <motion.div
                ...
                style={{ scaleX, background: "linear-gradient(90deg, #7B2FF7, #7B2FF7, #7B2FF7)" }}
            />
            ...
            <motion.button
                ...
                style={{ background: "rgba(255,255,255,0.9)", border: "1px solid rgba(30,27,58,0.09)", backdropFilter: "blur(12px)" }}
                title="Share article"
            >
                <Share2 className="w-4 h-4 text-[#6E6A85]" />
            </motion.button>
            ...
            {onBack && (
                <div className="max-w-4xl mx-auto px-6 lg:px-8 pt-8">
                    <button onClick={onBack}
                        className="flex items-center gap-2 text-sm font-semibold text-[#6E6A85] hover:text-[#7B2FF7] transition-colors duration-250">
            ...
            <section className="relative overflow-hidden pt-16 pb-12">
                ...
                <div className="absolute inset-0 pointer-events-none">
                    <div className="absolute -top-32 left-1/2 -translate-x-1/2 w-[800px] h-[400px] rounded-full opacity-30"
                        style={{ background: "radial-gradient(ellipse, rgba(123,47,247,0.1), transparent 70%)", filter: "blur(60px)" }} />
                    <div className="absolute top-0 right-0 w-[400px] h-[300px] rounded-full opacity-20"
                        style={{ background: "radial-gradient(circle, rgba(248,120,8,0.12), transparent 70%)", filter: "blur(50px)" }} />
                    <div className="absolute inset-0 opacity-100"
                        style={{ backgroundImage: "linear-gradient(rgba(30,27,58,0.025) 1px, transparent 1px), linear-gradient(90deg, rgba(30,27,58,0.025) 1px, transparent 1px)", backgroundSize: "72px 72px" }} />
                    {/* Particles */}
                    {[...Array(10)].map((_, i) => (
                        <motion.div key={i} className="absolute rounded-full"
                            style={{ width: 2, height: 2, background: i % 2 === 0 ? "#7B2FF7" : "#7B2FF7", left: `${(i * 18 + 5) % 95}%`, top: `${(i * 13 + 6) % 80}%`, opacity: 0.35 }}
                ...
                <div className="relative z-10 max-w-4xl mx-auto px-6 lg:px-8 text-center">
                    ...
                    <motion.p initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.55, delay: 0.18 }}
                        className="text-xl leading-8 text-[#6E6A85] max-w-2xl mx-auto mb-8">
                        {post.description}
                    </motion.p>
                    ...
                    <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.26 }}
                        ...
                        <div className="w-1 h-1 rounded-full bg-[#CBD5E1]" />
                        <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-semibold text-[#7B2FF7]"
            ...
            <section className="max-w-5xl mx-auto px-6 lg:px-8 mb-16">
                <motion.div
                    ...
                    style={{ boxShadow: "0 24px 80px rgba(30,27,58,0.13)" }}
                >
            ...
            <section className="max-w-3xl mx-auto px-6 lg:px-8 mb-20">
                ...
                >
                    <div className="w-20 h-20 rounded-full bg-gradient-to-br from-[#7B2FF7] to-[#7B2FF7] flex items-center justify-center shadow-xl shrink-0">
                    ...
                    {post.related.map((rel, i) => (
                        ...
                        <motion.div
                            ...
                            style={{
                                ...
                                boxShadow: "0 6px 30px rgba(30,27,58,0.06)",
                            }}
                        ...
                        >
                            ...
                            {/* Thumbnail */}
                            <div className="relative h-52 overflow-hidden bg-[#FAFAFC]">
                        ...
                        "
                                ...
                                {/* Description */}
                                <p className="text-sm leading-7 text-[#6E6A85] mb-6 line-clamp-2">
                                    {rel.description}
                                </p>

                                {/* Footer */}
                                <div className="flex items-center justify-between pt-5 border-t border-[rgba(30,27,58,0.06)]">
                ...
                <div className="relative z-10 py-20 px-8 lg:px-16 text-center">
                    <motion.div initial={{ opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
                        ...
                        <div className="flex flex-wrap justify-center gap-3">
                            {[
                                { label: "✓ Free Assessment", color: "#7B2FF7", bg: "rgba(248,120,8,0.1)", border: "rgba(248,120,8,0.22)" },
                                { label: "✓ Verified Tutors", color: "#7B2FF7", bg: "rgba(123,47,247,0.1)", border: "rgba(123,47,247,0.22)" },
                                { label: "✓ Home & Online Tuition", color: "#7B2FF7", bg: "rgba(123,47,247,0.1)", border: "rgba(123,47,247,0.22)" },
                            ].map((chip) => (
