...
export const BLOG_POSTS: BlogPost[] = [
    {
        ...
        categoryBg: "rgba(123,47,247,0.09)",
        categoryBorder: "rgba(123,47,247,0.2)",
        ...
        heroGrad: "from-[#7B2FF7] to-[#7B2FF7]",
        ...
        related: [
            ...
            { id: "time-management-students", description: "Maximize your productivity with these effective time management strategies.", author: "John Doe", category: "Productivity", categoryColor: "#7B2FF7", categoryBg: "rgba(123,47,247,0.1)", title: "5 Effective Time Management Tips for Students", readTime: "4 min", grad: "from-[#7B2FF7] to-[#7B2FF7]", role: "Author", image: "https://chrysalishigh.com/wp-content/uploads/2023/12/Quick-tips-for-Time-Management.jpg", authorImage: "https://akm-img-a-in.tosshub.com/indiatoday/images/story/201709/yt-story_647_090517015649.jpg?VersionId=wIQL131pthcasFzFyaoG5zYUwtLu961c", },
        ],
    },
    {
        ...
        category: "Parenting",
        categoryColor: "#7B2FF7",
        categoryBg: "rgba(248,120,8,0.09)",
        categoryBorder: "rgba(248,120,8,0.2)",
        ...
        heroGrad: "from-[#EA580C] to-[#C2410C]",
